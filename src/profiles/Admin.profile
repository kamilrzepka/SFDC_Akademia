...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <classAccesses>
        <apexClass>ASFDC_AccountTriggerHandler</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>ASFDC_ContactTriggerHandler</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>ASFDC_CustomClass</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>ASFDC_SecondCustomClass</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>ASFDC_TaankInfo</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>ASFDC_TankControllerExtension</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>ASFDC_TankCustomController</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>ASFDC_TriggerFactory</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>ASFDC_TriggerHandler</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>ASFDC_TurretDetail</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>ASFDC_TurretOneDetail</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <custom>false</custom>
    <layoutAssignments>
        <layout>ASFDC_AllTypes__c-Custom Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>ASFDC_Employee__c-ASFDC_Employee Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>ASFDC_Gun__c-ASFDC Gun Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>ASFDC_Invoice__c-ASFDC_Invoice Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>ASFDC_Soldier_Pole__c-ASFDC Soldier Pole Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>ASFDC_Tank__c-ASFDC Tank Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
        <layout>ASFDC_Turret__c-ASFDC Turret Layout</layout>
    </layoutAssignments>
    <pageAccesses>
        <apexPage>ASFDC_AllType</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>ASFDC_GunDetailExtension</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>ASFDC_TankCustomView</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>ASFDC_TankExtensionView</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
    <pageAccesses>
        <apexPage>ASFDC_TankStandardrView</apexPage>
        <enabled>true</enabled>
    </pageAccesses>
